...
<body class="full-page">
		...
		<nav class="navbar navbar-expand-lg">
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					...
					<li class="nav-item">
				<a class="nav-link" href="{{route('portfolio')}}">Portfolio
				</a>
			</li>
					</ul>
	...
	<!-- Sub Banner Section -->
	<section class="sub-banner" data-parallax="scroll" data-image-src="./assetss/images/banners/about-us-top-banner.jpg">
		<div class="container">
			<div class="row">
			...
			<div class="row justify-content-center">
				...
				<div class="col-lg-10">
					<ul class="about__list text-center">
						...
						<li class="about__list__item" data-aos="fade-up-right">
							<h3 class="about__list__item__title">Dashboard.</h3>
			...
			<div class="container">
				<div class="row align-items-center">
					...
					<div class="col-md-auto text-center mx-auto my-3 my-md-0">
						<p class="footer__copyright mb-0">karabuk © 2024 <a href="./" class="footer__copyright__link">Pharmacy Files</a></p>
					</div>
							...
							<div class="col-lg-6">
								<div class="form-group">
									<label class="form-group-label">
										...
										<input type="email" class="form-control" name="email" placeholder="yourname@address.com" required>
										<div class="invalid-tooltip">
	...
	<div class="modal fade" id="loginModal" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="loginModalLabel" aria-hidden="true">
		<div class="modal-dialog modal-dialog-centered">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="{{route('login')}}" class="form needs-validation" method="POST">
						@csrf
						<div class="form-row">
							<div class="col-12">
								<div class="form-group">
									<label class="form-group-label">
										<span class="form-group-label__text">Email <span class="text-danger">*</span></span>
										<input type="email" class="form-control" placeholder="yourname@address.com" name="email" required>
										<div class="invalid-tooltip">
											Please provide valid email address.
										</div>
									</label>
